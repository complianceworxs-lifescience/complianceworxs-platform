-- Add Attio push to the cascade. On INSERT, fire the pusher in parallel with Hunter.
-- Hunter finds the email; the pusher creates the Attio Person record.
-- They run concurrently because they don't depend on each other.
...
BEGIN
  ...
  -- ============================================================
  -- INSERT: log + fire enrichment + Attio push in parallel
  -- ============================================================
  IF TG_OP = 'INSERT' THEN
    ...
    -- CASCADE 1: Hunter enrichment (if no email yet)
    ...
    -- CASCADE 2: Attio push (parallel to Hunter; doesn't need email)
    IF NEW.linkedin_url IS NOT NULL
  ...
  -- ============================================================
  -- UPDATE: state changes + cascading dispatches
  -- ============================================================

  -- Email found -> fire fit scorer
